...
console.log(props.rules)
  ...
  return (
    <div className='pt-36 md:pt-0 md:mt-0 fixed inset-0 bg-opacity-30 backdrop-blur-sm flex items-center justify-center max-h-2xl overflow-y-auto overflow-x-hidden'>
