...
console.log(props.rules)
  ...
  return (
    <div className='pt-48 pb-8 md:pb-0 md:pt-0  fixed inset-0 bg-opacity-30 backdrop-blur-sm flex items-center justify-center  overflow-y-auto overflow-x-hidden'>
